...
function responseSuccess($data, $key = 'data', $msg = null, $status_code = 200, $options = ['isView' => false, 'view' => null]): View|Application|Factory|JsonResponse|FoundationApplication
{
    // return if view
    if ($options['isView']) {
...
function responseError($msg = "Error", $errorNum = "DATAE0", $status_code = 200): \Illuminate\Http\JsonResponse
{
    $returnData = [
        'status'    => false,
        'errorNum'  => $errorNum,
