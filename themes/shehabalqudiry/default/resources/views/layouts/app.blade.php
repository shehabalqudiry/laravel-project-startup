...
<body class="vertical  dark rtl ">
    ...
    <script src='{{ theme_asset('js/daterangepicker.js') }}'></script>
    <script src='{{ theme_asset('js/jquery.stickOnScroll.js') }}'></script>
    <script src="{{ theme_asset('js/tinycolor-min.js') }}"></script>
    <script src="{{ theme_asset('js/config.js') }}"></script>
    <script src="{{ theme_asset('js/apps.js') }}"></script>
    {{--  <script>
